...
analytics_data = patterns('locksmith.hub.dataviews',
    ...
    url(r'^data/keys/active/monthly/$', 'active_api_keys_monthly',
        name='active-keys-monthly'),
    url(r'^data/keys/active/yearly/$', 'active_api_keys_yearly',
        name='active-keys-yearly'),
