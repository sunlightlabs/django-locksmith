...
analytics = patterns('locksmith.hub.views',
    ...
    url(r'^new/keys/leaderboard/$', 'keys_leaderboard'),
    url(r'^new/keys/leaderboard/(?P<year>\d{4})/(?P<month>\d{1,2})/$', 'keys_leaderboard'),
    url(r'^new/keys/leaderboard/(?P<api_name>[-\w]+)/(?P<year>\d{4})/(?P<month>\d{1,2})/$', 'keys_leaderboard'),
    url(r'^new/keys/(?P<api_name>[-\w]+)/leaderboard/$', 'keys_leaderboard'),
