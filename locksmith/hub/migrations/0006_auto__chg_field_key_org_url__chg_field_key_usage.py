...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Key.org_url'
        db.alter_column('locksmith_hub_key', 'org_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Key.usage'
        db.alter_column('locksmith_hub_key', 'usage', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Key.org_url'
        db.alter_column('locksmith_hub_key', 'org_url', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Key.usage'
        db.alter_column('locksmith_hub_key', 'usage', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        u'hub.key': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'api_key'", 'unique': 'True', 'null': 'True', 'to': u"orm['auth.User']"})
        },
