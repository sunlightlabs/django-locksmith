...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Api.querybuilder_link'
        db.add_column('locksmith_hub_api', 'querybuilder_link',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Api.querybuilder_link'
        db.delete_column('locksmith_hub_api', 'querybuilder_link')
